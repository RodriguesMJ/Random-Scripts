...
plot(((1:size(GaussCoeff_A4cryo_R2, 3))/2)-56,r(:,2))
grid on
axis([-50 2000 0 10])

%Set axis labels
xlabel('Time (seconds)','Interpreter','latex');
ylabel('Area under 600 nm peak','Interpreter','latex');
...
scale_factor = 156/1000; %// change this to your satisfaction
