...
clearvars r
r(:,1)=GaussCoeff_MPD_R1(1,1,:);
r(:,2)=smooth(r(:,1),100,'sgolay',2);
plot(((1:size(GaussCoeff_MPD_R1, 3))/2)-116,r(:,2))
grid on
axis([-67 2000 0 35])

%Set axis labels
xlabel('Time (seconds)','Interpreter','latex');
ylabel('Area under 224 nm peak','Interpreter','latex');
...
scale_factor = 139/1000; %// change this to your satisfaction
