...
plot(((1:size(GaussCoeff_Water_R3, 3))/2)-60,r(:,2))
grid on
axis([-60 2000 0 2.5])

%Set axis labels
xlabel('Time (seconds)','Interpreter','latex');
ylabel('Area under 270 nm peak','Interpreter','latex');
...
scale_factor = 130/1000; %// change this to your satisfaction
